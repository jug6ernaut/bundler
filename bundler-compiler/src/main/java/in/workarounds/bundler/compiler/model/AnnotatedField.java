...
public class AnnotatedField {
    ...
    public AnnotatedField(Element element, Provider provider, Class<?> annotation, boolean isField, String name, TypeName type, ClassName serializer, String keyValue) {
